      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "64px 24px" }}>
        ...
        <div style={{ marginBottom: 48, borderBottom: `1px solid ${pd.mist}`, paddingBottom: 24 }}>
          ...
          <p style={{ margin: "16px 0 0", color: pd.graphite, fontSize: 16 }}>
            Updates regarding your orders, account, and exclusive offers.
          </p>
        </div>

        <div style={{ animation: "fadeSlideIn 0.3s ease" }}>
          <div style={{ border: `1px solid ${pd.mist}`, padding: 64, textAlign: "center", background: pd.paperWhite }}>
            <div style={{ fontSize: 48, color: pd.ashBorder, marginBottom: 16 }}>🔕</div>
            <h2 style={{ fontFamily: "var(--font-exposure-style-serif-exposure-10, 'Playfair Display', serif)", fontSize: 24, margin: "0 0 8px", fontWeight: 400 }}>
              You're all caught up
            </h2>
            <p style={{ margin: "0 0 32px", color: pd.graphite, fontSize: 15 }}>
              There are no new notifications to show right now. We'll let you know when something important happens.
            </p>
            <button onClick={() => router.push("/products")} className="pd-btn">
              Continue Shopping
            </button>
          </div>
        </div>
