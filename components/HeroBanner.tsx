...
export default function HeroBanner({
  ...
  return (
    <section className="w-full relative overflow-hidden" style={{ minHeight: '75vh' }}>
      ...
      {banners.map((b, i) => (
        ...
        >
          ...
          <div className="w-full md:w-1/2 bg-[#0c0c0c] flex flex-col justify-center px-8 md:px-16 lg:px-20 py-16 relative z-10">
            {/* Eyebrow */}
            <span
              className="text-white/70 text-[12px] font-bold uppercase mb-4"
            ...
            {/* Display headline */}
            <h1
              className="display-serif text-white m-0 mb-4 max-w-[480px]"
              style={{
            ...
            {/* Subtext */}
            <p className="text-white/70 text-[16px] m-0 mb-8 max-w-[400px] leading-relaxed">
              {b.sub}
            </p>
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <button
                ...
                className="bg-transparent text-white border border-white px-6 py-3 rounded text-[14px] font-bold uppercase cursor-pointer transition-opacity hover:opacity-80"
                style={{ letterSpacing: '0.057em' }}
              >
                Explore All
              </button>
